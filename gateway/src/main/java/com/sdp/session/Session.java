...
import com.sdp.trade.BlotterSubscription;
 ...
 * Also owns its blotter subscription (issue #152, ADR 0028), the same kind
 * of property for TRADE_CREATED's blotter-refresh delivery.
 *
...
public record Session(
        String id, String username, Set<String> roles,
        SymbolSubscription subscriptions, BlotterSubscription blotterSubscription, PendingTradeIds pendingTrades) {

    public Session(String id, String username, Set<String> roles) {
        this(id, username, roles, new SymbolSubscription(), new BlotterSubscription(), new PendingTradeIds());
    }
}
