...
* Testcontainers — adopted in MVP 0.4 (issue #34), see [ADR 0002](decisions/0002-containerization-and-testcontainers.md); backend integration tests needing a real database implement `PostgresIntegrationTest`
